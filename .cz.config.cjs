module.exports = {
  ...
  footerPrefix: 'Refs',
  messages: {
    type: "Select the type of change that you're committing: (required)",
    scope: 'What is the scope of this change (e.g., web, api, shared): (required)',
    customScope: 'Denote the scope of this change: (required)',
